            ...
            if (key == 0||key == 7){
                switch (key){
                    ...
                    case 1:
                        ...
                        System.out.println("A) "+list.Display(list));
                        System.out.println("B) "+list2.Display(list2));

                    case 2:
                        Mergelist = Linkedlist.Merge(list,list2);
                        System.out.println("C) Merge "+Mergelist.Display(Mergelist));
                    case 3:
                        Mergelist.sortList(Mergelist);
                        System.out.println("C) Merge "+Mergelist.Display(Mergelist));
                    case 4:
                        System.out.print("Enter the value to delete from Merge Linkedlist: ");
                        in = scan.nextInt();
                        Mergelist.deleteByValue(Mergelist,in);
                        System.out.println(Mergelist.Display(Mergelist));
                    case 5:
                        System.out.print("Enter the value to Search from Merge Linkedlist: ");
                        in = scan.nextInt();
                        System.out.println(in+(Mergelist.Search(Mergelist,in) ? " ":" not")+" found in the Merge Linkedlist: ");
                    case 6:
                        System.out.println("Odd in the Merge Linkedlist: "+ Mergelist.countOdd(Mergelist));
                        System.out.println("Even in the Merge Linkedlist: "+ Mergelist.countEven(Mergelist));
                    case 7:
