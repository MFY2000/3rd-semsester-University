...
public class Main {
    public static void main(String[] args) {
        ...
        int insertion,seletion;

        Sorting ob = new Sorting();
        insertion = ob.SelectionSorting(array);
        seletion = ob.InsertionSorting(array);

        String temp = "The best Sorting technique is can be choose by the comparing the count of inner loop\nso the best way is ";



        temp += (insertion < seletion?"Selection Sorting":"Insertion Sorting");
